    ...
    public function getCajas()
    {
        ...
        if ($empleadoCaja != null) {
            ...
            if ($cajaAsignada->ocupada) { //si la caja esta ocupada
                return response()->json(['success' => false, 'msg' => 'Ya tiene una caja asignada']);
            } else {
                $Cajas = Caja::where('ocupada', false)->get(); //me trae las cajas que esten desocupadas
                return response()->json(['success' => true, 'msg' => $fechaActual, 'Cajas' => $Cajas]);
            }
        } else {
            $Cajas = Caja::where('ocupada', false)->get(); //me trae las cajas que esten desocupadas
            return response()->json(['success' => true, 'Cajas' => $Cajas]);
        }
    }
