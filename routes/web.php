...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    //VEndedor
    Route::post('vendedor/show', ['as'=>'vendedor.show', 'uses'=>'UserController@getVendedor']);
    //CRUD abonosventa
    ...
    Route::get('/zona/search/rutas/json', ['as'=>'zona.search.rutas.json', 'uses'=>'ZonaController@getRutas']);
    Route::get('/zona/vendedor/asignar_ruta', ['as'=>'zona.vendedor.asignar_ruta', 'uses'=>'ZonaController@asignarZona']);
    Route::post('/zona/vendedor/actualizar_asignacion', ['as'=>'zona.vendedor.actualizar_asignacion', 'uses'=>'ZonaController@actualizarAsginacion']);
    Route::get('searchajax', ['as'=>'searchajax', 'uses'=>'ZonaController@autoComplete']);
